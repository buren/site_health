...
require "site_health/journals/journal"
require "site_health/journals/json_journal"
...
require "site_health/checkers/json_page"
...
module SiteHealth
  class Check
    ...
    def call
      ...
      spider = Spidr.site(site) do |spider|
        ...
        spider.every_page do |page|
          ...
          if page.json?
            result = Checkers::JSONPage.check(page)
            json_error_urls << result if result.errors?
            urls[page.url][:json] = result
          end
    ...
    # @return [Array<BrokenLinkJournal>]
    ...
    # Finds all pages which have broken links (the server failed to return a response)
